...
- **Enforcement in code rather than in instructions**: Part 3 is the first taste, and [Direction 4 of the Responsible AI Capstone]({{ site.baseurl }}/Assignments/ResponsibleAI#direction-4-containerizing-an-ai-system-safely) is the full version, with trust boundaries and a tested threat model.
